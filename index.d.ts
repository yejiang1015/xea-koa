...
export declare function route(handle: (route: Router<any, {}>) => Router<any, {}>): void;
export declare function listen(prefix?: string, port?: number, hostname?: string, listeningListener?: () => void): void;
